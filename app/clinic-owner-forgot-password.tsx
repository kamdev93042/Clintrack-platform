...
export default function ClinicOwnerForgotPasswordScreen() {
  ...
  const handleSendOTP = async () => {
    ...
    setLoading(true);
    try {
      const result = await ClinicOwnerAuthService.forgotPassword(email.trim());
      
      if (result.success) {
        // Navigate immediately to OTP verification screen
        router.push({
          pathname: '/clinic-owner-verify-otp',
